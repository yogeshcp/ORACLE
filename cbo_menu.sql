...
prompt @sql_children         @sts_baseline*        @top
prompt @query_defs           @hint_baseline*       @top_io
prompt @xplan_cache                                @top_cpu
prompt @xplan_awr                                  @longops
prompt @xplan_sts                                  @cursql
prompt @xplan_baseline                             @version_count
